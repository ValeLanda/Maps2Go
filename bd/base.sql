...
alter table tema add constraint "tema_fk" foreign key(nombre_usuario) references usuario(nombre_usuario)
...
alter table comentario add constraint "comentario_fk_usuario" foreign key(nombre_usuario) references usuario(nombre_usuario)
on delete cascade on update cascade;